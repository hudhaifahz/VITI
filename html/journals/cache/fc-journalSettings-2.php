<?php return array (
  ...
  'categories' => NULL,
  'contactEmail' => 'dr.anowar.zahid@gmail.com',
  'contactFax' => '',
  'contactName' => 'Anowar Zahid',
  'contactPhone' => '+60193668390',
  'contributors' => 
  array (
  ),
  'copyrightHolderType' => '',
  ...
  'copyrightYearBasis' => '',
  'copySubmissionAckAddress' => 'afzana.jahan@yahoo.ca',
  'copySubmissionAckPrimaryContact' => true,
  'copySubmissionAckSpecified' => true,
  'disableUserReg' => false,
  'displayCurrentIssue' => true,
  'emailSignature' => 'Dr. Anowar Zahid / Director
____________________________________________________________
Vancouver Journal of International Business and Law (VJIBL)
http://viti.ca/journals/index.php/test',
  ...
  'journalTheme' => '',
  'licenseURL' => '',
  'mailingAddress' => '<p>201-12125 75A Avenue</p><p>Surrey, BC V3W 1B9</p>',
  ...
  'supportEmail' => 'hudhaifah@viti.ca',
  'supportName' => 'Hudhaifah Zahid',
  'supportPhone' => '+17788835390',
  ...
  'authorGuidelines' => 
  array (
    'en_US' => 'We welcome submissions of scholarly articles and book reviews.',
  ),
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/journals/index.php/test/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/journals/index.php/test/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/journals/index.php/test/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/journals/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'contactAffiliation' => 
  array (
    'en_US' => 'Associate Professor of International Trade Law 
Faculty of Law
...
Bangi 43600, Selangor, Malaysia',
  ...
  array (
    'en_US' => '<p>Director<br />Vancouver International Trade Institute (VITI)</p><p>201-12125 75A Avenue</p><p>Surrey, BC W3V 1B9</p><p>Phone: +17788835390</p><p> </p>',
  ),
  'contactTitle' => 
  array (
    'en_US' => 'Dr.',
  ...
  'layoutInstructions' => 
  array (
    'en_US' => 'Download the final copyedited version of the submission, convert it to PDF, and upload back into OJS.',
  ),
  ...
  'pubFreqPolicy' => 
  array (
    'en_US' => 'This journal will be published quarterly.',
  ),
  ...
  'publisherNote' => 
  array (
    'en_US' => '<p>Vancouver International Trade Institute (VITI)</p><p>201-12125 75A Avenue</p><p>Surrey, BC W3V 1B9</p><p> </p>',
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/journals/index.php/test/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/journals/index.php/test/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  'searchDescription' => 
  array (
    'en_US' => 'This journal publishes contributions on any issue of international business from legal, non-legal and interdisciplinary perspectives.',
  ),
  'searchKeywords' => 
  array (
    'en_US' => 'International and comparative trade and business, business and law, finance, economics, policy, diplomacy, politics, and sociology',
  ),
  'submissionChecklist' => 
  array (
    'en_US' => 
    array (
      ...
      array (
        'order' => '5',
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="/journals/index.php/test/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://viti.ca/journals/index.php/test/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
      ),
      6 => 
      array (
        'order' => '7',
        'content' => 'The author profile is complited and updated.',
      ),
    ),
  ),
  ...
  'title' => 
  array (
    'en_US' => 'Vancouver Journal of International Business and Law',
  ),
  'waiverPolicy' => 
  array (
