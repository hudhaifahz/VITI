...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('forms', module.exports = function($, _) {
	  ...
	  function build(i, el) {
	    ...
	    // Custom form action
	    //if (action) return;
		if (siteId) { data.handler = submitGoogle; return; }
...
//	    if (siteId) { data.handler = submitWebflow; return; }
	  ...
	  function submitGoogle(data) {
		  ...
		  //document.getElementById("email-form").elements["foo"]
		  
		  var title = $('#entry_760520063').val();
		  var surname = $('#entry_1210256521').val();
		  var name = $('#entry_1600021572').val();
		  var email = $('#entry_383363257').val();
		  var interest = $('#entry_914743428').val();
		  
		  
		  var payload = {
			  
			  "entry.760520063" : title, 
			  "entry.1210256521" : surname,
			  "entry.1600021572" : name, 
			  "entry.383363257" : email,
			  "entry.914743428" : interest
	      ...
	      var url = "https://docs.google.com/forms/d/e/1FAIpQLSfPMlywUIW4QO2TQvqwWv0Rb-xkymgoGpE4DQgchtaKqwWl9g/formResponse";
